...
curcontent["kit-joker1"] = {
	...
	<button class="btn btn-secondary" onclick="Open(\'kit-free\', false);">X10|Стартовые</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-kaban\', false);">X10|MVP</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik\', false);">X10|BEST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik\', false);">X10|FAST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-smert\', false);">X10|BOOST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-free1\', false);">X5|Стартовые</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-kaban1\', false);">X5|MVP</button>\
...
curcontent["kit-smert1"] = {
	...
	<button class="btn btn-secondary" onclick="Open(\'kit-joker\', false);">X10|BEST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik\', false);">X10|FAST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik\', false);">X10|BOOST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-free1\', false);">X5|Стартовые</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-kaban1\', false);">X5|MVP</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-joker1\', false);">X5|BEST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik1\', false);">X5|FAST</button>\
