...
function OvhUrlOverrite() {
  ...
  for (var i = 0; i < slides.length; i++) {
    ...
    if (urlelelink && urlelelink.startsWith('https://pay.moscow.ovh')) {
  ...
  <div class="x-spoiler">
    ...
    <div class="spoil-box">
      ...
      <blockquote class="spoil-Untext">
        ...
        » Не отправляйте скины дешевле 5₽ (CS2)<br>
...
window.addEventListener("load", function () {
  try {
    ...
    console.log("SteamID не получен: " + e);
  }
});

// Повторно пытаемся заменить ссылки каждую секунду, как на BLOOD
setInterval(() => {
  try {
    OvhUrlOverrite();
  } catch (e) {
    console.log("OvhUrlOverrite ошибка: " + e);
  }
}, 1000);
