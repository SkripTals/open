...
curcontent["kit-free"] = {
	...
	<button class="btn btn-secondary" onclick="Open(\'kit-joker\', false);">MVP</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-masnik\', false);">BEST</button>\
	<button class="btn btn-secondary" onclick="Open(\'kit-smert\', false);">FAST</button>\
