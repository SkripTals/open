...
curcontent["skins"] = {
  ...
  xcon: `<div class="x-spoiler">
    ...
    <div class="spoil-box">
      <span class="spoil-close fa"></span><span class="spoil-open fa"></span>
      <span class="spoil-head">Что значит пополнение напрямую?</span><br>
      <blockquote class="spoil-Untext">
        Обычно пополнение скинами происходит через сторонние сервисы, которые удерживают до 50% стоимости. Мы предлагаем вам пополнение почти по рыночной цене — напрямую, без посредников.
      </blockquote>
    </div>
  </div>
  ...
  <div class="x-spoiler">
    ...
    <div class="spoil-box">
      <span class="spoil-close fa"></span><span class="spoil-open fa"></span>
      <span class="spoil-head">Ограничения при пополнении</span><span class="skin-warning"> обязательно прочти</span>
      <blockquote class="spoil-Untext">
        » У вас <b>не должно</b> быть задержки <b>15 дней</b> на обмены<br>
        » Принимаются скины только из <b>RUST</b> и <b>CS2</b><br>
        » Не более 12 предметов за раз<br>
        » Не отправляйте скины дешевле 15₽ (CS2)<br>
        » Баланс пополняется только для аккаунта, с которого отправлен обмен<br>
        » Зачисление обычно в течение 1–5 минут
      </blockquote>
    </div>
  </div>
  ...
  <div class="x-spoiler">
    ...
    <div class="spoil-box">
      <span class="spoil-close fa"></span><span class="spoil-open fa"></span>
      <span class="spoil-head">Хочу пополнить баланс скинами</span><br>
      <blockquote class="spoil-Untext">
        Перейдите по кнопке ниже, выберите нужные скины, нажмите "Предложить обмен" и подтвердите в приложении Steam.<br><br>
        <div class="btn-skins">
          <a class="btn-skin" href="https://steamcommunity.com/tradeoffer/new/?partner=1876222817&token=1A1PMWAN" target="_blank">Начать обмен</a>
        </div>
      </blockquote>
    </div>
  </div>
  ...
  <div class="row-skins">
    <a class="container-user" href="https://vk.com/im?sel=-203320496" target="_blank">
      <img alt="" src="https://i.imgur.com/Mf5iBn3.jpeg" class="icon-user">
      <div class="textContainer-user">
        <span class="name-user">Группа ВК</span>
        <span class="category-user">Для связи</span>
      </div>
    </a>
    <a class="container-user1" href="https://discord.com/invite/MHKxBRbZ8g" target="_blank">
      <img alt="" src="https://i.imgur.com/GA8l3vU.jpeg" class="icon-user1">
      <div class="textContainer-user1">
        <span class="name-user1">Дискорд сервер</span>
        <span class="category-user1">Для связи</span>
      </div>
    </a>
  </div>`
};
...
curcontent["Oplata"] = {
  ...
  xcon: `
  <div class="xbox_custom_rules" style="padding: 0 20px 20px 20px;">
    <p style="font-size: 18px; font-weight: bold;">Выберите способ пополнения</p>

    <div class="oplata_cont" onclick="Open('skins')">
      <a class="container-oplata">
        <img alt="Скины" src="https://i.imgur.com/iV8LCN1.png" class="icon-user-oplata">
        <div class="textContainer-oplata">
          <span class="name-user">Пополнить скинами</span>
          <span class="category-user">Через Steam Trade</span>
        </div>
      </a>
    </div>

    <div class="oplata_cont">
      <form onsubmit="return qiwiHandler(event)" id="qiwi-inp-form" method="get" target="_blank" action="https://oplata.qiwi.com/create">
        <div class="qiwi-inp-box">
          <label for="qiwi-donation-amount" class="qiwi-label">Сумма</label>
          <div class="qiwi-rub">₽</div>
          <input type="tel" placeholder="Сумма" id="qiwi-donation-amount" name="amount" required>
          <input type="hidden" id="qiwi-donation-comment" name="comment" value="Пожертвование на krasnoyarsk rust">
        ...
        <div class="qiwi-button-box">
          <button class="qiwi-submit-main" id="qiwi-submit-main" type="submit">Оплатить картой / QIWI</button>
        </div>
      </form>
    </div>
  </div>
